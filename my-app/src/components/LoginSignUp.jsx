            ...
            <div id="signup">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="field-wrap">
                  ...
                  <input className='input' type="password" name="password" value={formData.password} onChange={handleInputChange} required />
                </div>
                <div className="field-wrap">
                  <label className='label'>Phone<span className="req">*</span></label>
                  <input className='input' type="text" name="phone" value={formData.phone} onChange={handleInputChange} required />
                </div>
                <div className="field-wrap">
                  <label className='label'>Additional Phone</label>
                  <input className='input' type="text" name="addPhone" value={formData.addPhone} onChange={handleInputChange} />
                </div>
